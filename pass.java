                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(MDP, javax.swing.GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE)
                            .addComponent(ID)
...
//        }
            ...
            boolean logniveau = false;
            
            if(!value1.isEmpty() && !value2.isEmpty()){
                PDO.Uuser = value1; //Logger.getLogger(pass.class.getName()).log(Level.SEVERE, null, ex);
                PDO.Upassword = value2;
                try{
                   ...
                   Connection con = pdoInstance.pdo();
                    ...
                    System.out.println("LOG to user"); 
             
            String rs = "select * from Membres WHERE Username =  ? AND Pass = ?";
            PreparedStatement stm=con.prepareStatement(rs);
            


                    stm.setString(1,   PDO.Uuser);
                    stm.setString(2,   PDO.Upassword);
                    ResultSet res = stm.executeQuery();
                    
                     if(res.next()){
                       PDO.Univeau = res.getString(34);     
        ...
        int largeur = tailleEcran.width;
                    ...
                    Interface Interface = new Interface();
                     Interface.setSize(largeur/3, hauteur/3);
                    Interface.setVisible(true);  
                    dispose();
               
                     }else{
                         System.out.println("User/MDP Wrong");  
                         
                                         System.out.println( PDO.Uuser);  
                         System.out.println( PDO.Upassword);  
